...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Total Credit", "fieldname": "total_credit", "fieldtype": "Currency", "width": 250},
        {"label": "Total Debit", "fieldname": "total_debit", "fieldtype": "Currency", "width": 250},
        {"label": "Profit & Loss", "fieldname": "profit_and_loss", "fieldtype": "Currency", "width": 250},
    ]
    ...
    if from_date and to_date:
        job_details_filters['date'] = ['between', [from_date, to_date]]  # Assuming `date` is the field in `Job Details` to filter by date
